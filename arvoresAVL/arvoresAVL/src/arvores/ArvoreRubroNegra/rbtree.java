...
{  
    private static rbtree nullNode;   //define null node  
    private rbtree current;   //define current node   
    private rbtree parent;    //define parent node   
    private rbtree header;   // define header node  
    private rbtree grand; //define grand node  
    private rbtree great; //define great node  
    ...
    {  
        ...
        current = new rbtree(newElement, nullNode, nullNode);  
    ...
    private rbtree performRotation(int newElement, rbtree parent)  
    {  
    ...
    private rbtree rotationWithLeftChild(rbtree node2)  
    {  
        rbtree node1 = node2.leftChild;  
    ...
    private rbtree rotationWithRightChild(rbtree node1)  
    {  
        rbtree node2 = node1.rightChild;  
    ...
    private int nodesInTree(rbtree node)  
    {  
        if (node == nullNode)  
            return 0;  
        else  
    ...
    private boolean searchNode(rbtree node, int value)  
    {  
        boolean check = false;  
    ...
    private void preorderTraversal(rbtree node)  
    {  
        if (node != nullNode)  
        {  
            char c = 'R';  
    ...
    private void inorderTraversal(rbtree node)  
    {  
        if (node != nullNode)  
        {  
    ...
    private void postorderTraversal(rbtree node)  
    {  
        if (node != nullNode)  
        {  
